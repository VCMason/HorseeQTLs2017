...
# Genotype file name
SNP_file_name = paste(base.dir, "dataIN/RCA6_no559443/82_RAO_HD.2M.RCA6.trim2eQTLIndivs.ne1e3.MateQTL.TagSNP.tab", sep="");
snps_location_file_name = paste(base.dir, "dataIN/RCA6_no559443/82_RAO_HD.2M.sort.trim2eQTLIndivs.ne1e3.MateQTL.AllSNPLoc.tab", sep="");

# Gene expression file name
expression_file_name = paste(base.dir, "dataIN/RCA6_no559443/residuals.RCA6.VSD.MatrixeQTL.sort.tx.tab", sep="");
gene_location_file_name = paste(base.dir, "dataIN/RCA6_no559443/features.NCBI.RCA6.trim.MatEQTL.tx.tab", sep="");

# Covariates file name
# Set to character() for no covariates
covariates_file_name = character() # paste(base.dir, "dataIN/RCA6_no559443/RAO_database.VCM.v4.RCA6.no5594.Mateqtl.binary.wFactors.csv", sep="");
